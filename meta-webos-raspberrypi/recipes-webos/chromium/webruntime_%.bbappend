...
PACKAGECONFIG:remove:raspberrypi3 = "gstreamer umediaserver neva-media gav"
PACKAGECONFIG:remove:raspberrypi3-64 = "gstreamer umediaserver neva-media gav"

PACKAGECONFIG_NEVA_WEBRTC ?= "neva-webrtc"
PACKAGECONFIG:append:raspberrypi4 = " ${PACKAGECONFIG_NEVA_WEBRTC}"
