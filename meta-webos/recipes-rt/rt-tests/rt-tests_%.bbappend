...
RDEPENDS_${PN}-append_class-target = " ${VIRTUAL-RUNTIME_bash}"
RDEPENDS_${PN}-remove_class-target = "${@oe.utils.conditional('WEBOS_PREFERRED_PROVIDER_FOR_BASH', 'busybox', 'bash', '', d)}"
