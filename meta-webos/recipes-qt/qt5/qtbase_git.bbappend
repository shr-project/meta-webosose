...
# Patches from 5.12.meta-webos.18 based on 5.12.meta-qt5-shared.10
SRC_URI_append = " \
...
SRC_URI_append_hardware = " \
    file://0019-eglfs-Support-multiple-device-integration.patch \
    file://0020-eglfs-Support-multiple-display.patch \
    file://0021-eglfs-Associate-keyboard-touch-device-with-window.patch \
"
