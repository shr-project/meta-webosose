...
LIC_FILES_CHKSUM:raspberrypi4 += "file://oss-pkg-info.yaml;md5=2bdfe040dcf81b4038370ae96036c519"
...
DEPENDS:append:raspberrypi4 = " webos-wayland-extensions"

WEBOS_VERSION = "1.0.0-21_ecd90bea31daca759dc40061749131f2a61b99c1"
PR = "r8"

WEBOS_GIT_PARAM_BRANCH:raspberrypi4 = "@gav"
WEBOS_VERSION:raspberrypi4 = "1.0.0-21.gav.21_fcb0d9d9dd7e413af0adea2a95158a1ffca41842"
SRC_URI:append:raspberrypi4 = " file://0001-LunaServiceClient.cpp-include-string-to-fix-build-wi.patch"
