...
SRC_URI = " \
    ...
    git://github.com/pytorch/cpuinfo;branch=main;protocol=https;destsuffix=git/cpuinfo;name=cpuinfo \
    git://github.com/pytorch/cpuinfo;branch=main;protocol=https;destsuffix=git/clog;name=clog \
